...
export const MAP_ROLE_ID = {
  [USER_ROLES.ADMIN]: USER_ROLE_IDS.ADMIN,
  [USER_ROLES.EMPLOYEE]: USER_ROLE_IDS.EMPLOYEE,
  [USER_ROLES.MANAGER]: USER_ROLE_IDS.MANAGER,
  [USER_ROLES.CUSTOMER]: USER_ROLE_IDS.CUSTOMER,
  [USER_ROLES.AUTHENTICATED]: USER_ROLE_IDS.AUTHENTICATED,
};
